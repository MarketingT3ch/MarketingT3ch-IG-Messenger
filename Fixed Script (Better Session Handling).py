...
# ======================= CONFIGURATION =======================
ENCODED_GITHUB_TOKEN = "Z2hwXzA1dTI5RklWQ2pMOUNIMWtwWW1wTDVhZm9pOEZ0WTIyNTdtTQ=="  # Replace with your Base64-encoded token
GITHUB_USERNAME = "MarketingT3ch"
GITHUB_REPO = "Marketing_T3ch_Approvel"
GITHUB_FILE = "approved.txt"  # Approved codes file in GitHub repository

# Decode the token before use
